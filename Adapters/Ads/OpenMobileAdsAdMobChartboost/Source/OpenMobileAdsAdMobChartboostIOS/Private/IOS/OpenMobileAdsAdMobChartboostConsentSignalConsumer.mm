...
namespace
{
	...
	/** Keeps Chartboost GDPR state untouched till consent applicability or status is known. */
	...
	/** Derives Chartboost US privacy only from an explicit opt-out choice or processing mode. */
