...
namespace OpenMobileDeviceAndroidWindowMonitorPrivate
{
...
)
{
	...
	using namespace OpenMobileDeviceAndroidWindowMonitorPrivate;
...
JNI_METHOD void Java_com_epicgames_unreal_GameActivity_nativeOpenMobileDeviceWindowChanged(
	JNIEnv* Env,
	jobject Activity
)
{
	...
	OpenMobileDeviceAndroidWindowMonitorPrivate::NotifyChange();
}
