...
void UOpenMobileSensorsSubsystem::ReleaseRecordingSessionNative(
	FGuid RequestId)
{
	FOpenMobileSensorsRecordingService::ReleaseRecording(
		SubscriptionOwnerIdentifier,
		RequestId);
}
